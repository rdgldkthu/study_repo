...
public:
    ...
    void ex9()
    {
        ...
        typedef decltype((x))       x_wiht_parens_type; // add reference to lvalues
        typedef decltype((cx))      cx_wiht_parens_type;
        typedef decltype((crx))     crx_wiht_parens_type;
        typedef decltype((p->m_x))  m_x_wiht_parens_type;
    }
    ...
    void ex11()
    {
        ...
        typedef decltype(d1 < d2 ? d1 : d2) cond_type; // result is lvalue
        auto c = d1 < d2 ? d1 : d2;
